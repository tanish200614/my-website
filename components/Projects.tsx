...
const projects: { tag: Tag; title: string; role: string; period: string; description: string; bullets: string[]; stack: string[]; github: string; accent: string; badge: string }[] = [
  {
    ...
    role: 'Computer Vision Lead & Co-Founder',
    period: 'Aug 2025 – Present',
    description:
      'Lead a 6-member team building a ROS 2 autonomy stack for Robomasters competition robots across computer vision, tracking, and navigation.',
    bullets: [
      'Trained YOLO26n on 8k+ labeled armor-plate frames to 0.58 mAP@50:95 and integrated solvePnP pose estimation at 45 FPS on Jetson Orin Nano',
      'Implemented a constant-velocity Kalman filter for lead compensation, reducing angular tracking error 28% in autonomous shooting tests',
      'Built sentry-robot autonomy with FAST-LIO2, Livox MID-360 LiDAR, and Nav2 in ROS 2',
      'Achieved a 90% collision-free route-completion rate in Gazebo and on the physical robot',
    ],
    stack: ['C++', 'Python', 'ROS 2', 'OpenCV', 'YOLO', 'Nav2', 'FAST-LIO2', 'Jetson Orin'],
  ...
  },
  {
    ...
    role: 'Robotic Arm Controls Developer',
    period: 'Aug 2024 – Present',
    description:
      'Built closed-loop inverse-kinematics and workspace analysis tooling for a 5-DOF rover arm in a 30 Hz ROS 2 control loop.',
    bullets: [
      'Engineered a closed-loop Cartesian IK controller that improved target alignment accuracy 20%',
      'Integrated geometric IK solvers into a 30 Hz ROS 2 velocity pipeline with joint-limit checks',
      'Achieved under 1 cm convergence while reducing motor saturation 30%',
      'Built a Python reachability visualizer with dexterity scoring and draggable RViz obstacles, cutting validation time 50%',
    ],
